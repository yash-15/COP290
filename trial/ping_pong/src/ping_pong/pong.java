...
private int ballX = 100, ballY = 1000, Player1X=100, Player1Y=1000, Player2X=2300, Player2Y=1000;
Thread thread;
...
// Draw ships
gc.fillRect(Player1X, Player1Y, 10, 85);
gc.fillRect(Player2X, Player2Y, 10, 85);
